...
import { ExplanationPanel, ExplanationData, generateMockExplanationData } from '../../components/ExplanationPanel';
  ...
  return {
    ...
    selectedOption: message.metadata?.recommendation
      ? {
          ...
          name: message.metadata.options?.find(o => o.optionId === message.metadata?.recommendation)?.name || '추천 대안',
          type: message.metadata.options?.find(o => o.optionId === message.metadata?.recommendation)?.type || 'BALANCED',
...
export default function DecisionsPage() {
  ...
  const handleSendMessage = useCallback(async (message: string, constraints: Constraint[]): Promise<Message> => {
