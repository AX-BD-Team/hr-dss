...
import { GraphViewer, GraphData, GraphNode, GraphLink } from '../../components/GraphViewer';

// Mock 데이터 생성
const generateMockGraphData = (): GraphData => {
  const nodes: GraphNode[] = [
    // Organizations
    { id: 'ORG-0001', label: '디지털트랜스포메이션본부', type: 'OrgUnit', properties: { type: '본부' } },
    { id: 'ORG-0010', label: 'AI솔루션실', type: 'OrgUnit', properties: { type: '실' } },
    { id: 'ORG-0011', label: 'AI플랫폼팀', type: 'OrgUnit', properties: { type: '팀' } },
    { id: 'ORG-0012', label: 'MLOps팀', type: 'OrgUnit', properties: { type: '팀' } },
    { id: 'ORG-0020', label: '데이터엔지니어링실', type: 'OrgUnit', properties: { type: '실' } },

    // Employees
    { id: 'EMP-000001', label: '김영호', type: 'Employee', properties: { grade: '부장', status: 'ACTIVE' } },
    { id: 'EMP-000010', label: '이정수', type: 'Employee', properties: { grade: '부장', status: 'ACTIVE' } },
    { id: 'EMP-000011', label: '박민지', type: 'Employee', properties: { grade: '차장', status: 'ACTIVE' } },
    { id: 'EMP-000012', label: '최서연', type: 'Employee', properties: { grade: '과장', status: 'ACTIVE' } },
    { id: 'EMP-000020', label: '임하윤', type: 'Employee', properties: { grade: '차장', status: 'ACTIVE' } },

    // Projects
    { id: 'PRJ-2024-0001', label: '금융권 AI 챗봇', type: 'Project', properties: { status: 'ACTIVE', priority: 'HIGH' } },
    { id: 'PRJ-2024-0002', label: '제조사 MLOps', type: 'Project', properties: { status: 'ACTIVE', priority: 'HIGH' } },

    // Competencies
    { id: 'CMP-005', label: 'Machine Learning', type: 'Competency', properties: { domain: 'TECHNICAL' } },
    { id: 'CMP-007', label: 'Generative AI', type: 'Competency', properties: { domain: 'TECHNICAL' } },
    { id: 'CMP-008', label: 'MLOps', type: 'Competency', properties: { domain: 'TECHNICAL' } },
  ];
      ...
      {selectedNode && (
        <div className="card" style={{ marginTop: '24px' }}>
          ...
          <div className="grid grid-3">
            ...
            <div>
              <div style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>라벨</div>
              <div style={{ fontWeight: '500' }}>{selectedNode.label}</div>
            </div>
            <div>
              <div style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>타입</div>
              <div>
          ...
          {Object.keys(selectedNode.properties).length > 0 && (
            <div style={{ marginTop: '16px' }}>
              <div style={{ fontSize: '14px', fontWeight: '600', marginBottom: '8px' }}>속성</div>
      ...
      <div className="card" style={{ marginTop: '24px' }}>
        ...
        <div className="grid grid-4">
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ width: 16, height: 16, borderRadius: '50%', background: '#4CAF50' }} />
            <span>Employee (직원)</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ width: 16, height: 16, borderRadius: '50%', background: '#2196F3' }} />
            <span>OrgUnit (조직)</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ width: 16, height: 16, borderRadius: '50%', background: '#FF9800' }} />
            <span>Project (프로젝트)</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ width: 16, height: 16, borderRadius: '50%', background: '#00BCD4' }} />
